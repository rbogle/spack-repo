...
class Jdk(Package):
    ...
    def url_for_version(self, version):
        url = "http://download.oracle.com/otn-pub/java/jdk/{0}/{1}/jdk-{2}-linux-x64.tar.gz"
        lic = 'd54c1d3a095b4ff2b6607d096fa80163'
        version = str(version)
        if '-' in version:
        	minor_version = version[:version.index('-')]
        else:
		minor_version = version
        return url.format(version, lic, minor_version)
