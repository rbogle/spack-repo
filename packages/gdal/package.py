...
class Gdal(Package):
    ...
    version('2.2.0', '37d98d32d6ab0b2d7026a6089c3d17ba')
    version('2.1.3', 'e5057f6011b720cfbbebbbbf216c0ffe')
    version('2.1.2', 'bd283ff1f88dfe8d750dbc5ecb7c73a8')
    ...
    variant('geos', default=True, description='Enable GEOS support')
    variant('kea', default=True, description='Enable KEA support')
    variant('netcdf', default=True, description='Enable netcdf support')
    variant('kakadu', default=True, description='Enable kakadu support')
    ...
    def install(self, spec, prefix):
        ...
        if '+kakadu' in spec:
	    args.append('--with-kakadu=%s' % spec['kakadu'].prefix)
        args.append('CPPFLAGS=-fPIC')
